...
import { Target, Zap, Rocket, Activity, BarChart3, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-indigo-600 p-5 rounded-[32px] shadow-xl shadow-indigo-600/20 text-white relative overflow-hidden group">
          ...
          <div className="mt-4 flex items-center gap-1.5 bg-white/20 w-fit px-2 py-1 rounded-lg text-[10px] font-bold">
            <TrendingUp size={10} /> +12% к прошлой неделе
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-[32px] border border-slate-100 shadow-sm relative overflow-hidden">
          ...
          <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1 text-right">Нагрузка</p>
          <h3 className="text-4xl font-black text-slate-800 text-right">
          ...
          <p className="text-[10px] text-emerald-500 font-black text-right mt-4 flex items-center justify-end gap-1">
            <Rocket size={10} /> Команда в тонусе
          </p>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-black text-slate-800 tracking-tight">Активность системы</h3>
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Обновлено только что</p>
          </div>
      ...
      <div className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm">
        <h3 className="text-lg font-black text-slate-800 tracking-tight mb-4">Статусы проектов</h3>
